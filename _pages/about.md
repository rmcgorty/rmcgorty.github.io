...
**Undergraduate students should check out an opportunity to work on research projects in Mexico over the 2026 summer. Details here: [https://sites.google.com/view/nsf-ires-softmatter](https://sites.google.com/view/nsf-ires-softmatter)**

We maintain code for differential dynamic microscopy, an image analysis method we use in several projects. For more on that, see our [PyDDM documentation site](https://rmcgorty.github.io/PyDDM/build/html/index).
